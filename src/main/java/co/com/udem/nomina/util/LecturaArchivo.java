...
public class LecturaArchivo {
	...
	private void leerRegistro(String registro) {
		...
		//Debe almacenarse cada registro en un Hashtable, teniendo la cédula como clave. La idea es que un registro que ya esté en el Hashtable no se vuelva a almacenar. 		
		//Cuando el tamaño del Hashtable sea de tres registros imprimirlo y borrar los registros.
	}
